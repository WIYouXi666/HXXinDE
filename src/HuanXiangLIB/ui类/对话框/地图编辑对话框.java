...
public class 地图编辑对话框 extends MapEditorDialog {
    private MapView view;
    private 地图信息对话框 infoDialog;
    private 地图加载对话框 loadDialog;
    private 地图大小调整对话框 resizeDialog;
    ...
    public 地图编辑对话框() {
        ...
        resizeDialog = new 地图大小调整对话框((width, height, shiftX, shiftY) -> {
        ...
        loadDialog = new 地图加载对话框(map -> ui.loadAnd(() -> {
            try{
    ...
    public @Nullable Map save(){
        ...
        state.rules.objectives.each(MapObjectives.MapObjective::reset);
