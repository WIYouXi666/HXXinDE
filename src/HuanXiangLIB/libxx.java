...
import HuanXiangLIB.记录$功能.配置文件;
import arc.Core;
import arc.Events;
...
import static HuanXiangLIB.js.DawnRun;
import static HuanXiangLIB.js.RunName;
...
public class libxx {
    ...
    public static 标签lib 标签YY;
    public static 加载类 加载YY;

    public static 全部内容 内容YY;
    public static 配置文件 配置YY;

    public static void addjs(String name, Runnable run) {
        RunName.add(name);
        DawnRun.add(run);
    }
