...
public class 科技树 extends BaseDialog {
    ...
    public 科技树.TechTreeNode root = new 科技树.TechTreeNode(TechTree.roots.first(), null);
    ...
    public 科技树() {
        ...
        cont.stack(titleTable, view = new 科技树.View(), itemDisplay = new ItemsDisplay()).grow();
    ...
    public @Nullable TechTree.TechNode getPrefRoot() {
        Planet currPlanet = ui.planet.isShown() ?
                ui.planet.state.planet :
                state.isCampaign() ? state.rules.sector.planet : null;
    ...
    public class View extends Group {
        ...
        public void rebuildAll() {
            ...
            for (TechTreeNode node : nodes) {
                ...
                button.update(() -> {
                    ...
                    button.getImage().setColor(!locked(node.node) ? Color.white : node.selectable ? Color.white : Color.white);
        ...
        void rebuild(@Nullable boolean[] shine) {
            ...
            checkMargin();
            Core.app.post(科技树.this::checkMargin);
