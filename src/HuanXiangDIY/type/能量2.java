...
public class 能量2 extends UnlockableContent  {
    ...
    public static final Seq<能量2> all = new Seq<>();
    public int id;
    public Color color;
  /**
 * @see Item
 ...
 * */
    ...
    public int 过渡帧 = 0;
    public float 帧时间 = 5f;
    public 能量2(String name, Color color) {
        super(name);
        this.color = color;
    ...
    public 能量2(String name) { this(name, new Color(Color.black));}
