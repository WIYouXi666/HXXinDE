...
import HuanXiangDIY.type.*;
import HuanXiangDIY.主要.配方;
import HuanXiangDIY.事件.局内事件主类;
import HuanXiangDIY.测试的文件.测试;
import HuanXiangLIB.type.单位组装记录块;
import HuanXiangLIB.type.组装兵工厂;
...
import static HuanXiangLIB.记录$功能.标签lib.标签.核心标签内容;
...
//    }};
    ...
    public static void load() {
        ...
        new 单位注册类.注册能力("测试1", new ForceFieldAbility(100, 1, 10000, 0)
        );
        new 单位注册类.注册能力("测试2", new UnitSpawnAbility(UnitTypes.dagger, 600, 0, 0)
        );
        new 单位组装记录块();
