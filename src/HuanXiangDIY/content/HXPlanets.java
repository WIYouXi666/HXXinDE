...
import HuanXiangDIY.HXtype.有限矿;
import HuanXiangDIY.HXtype.采矿机;
import HuanXiangDIY.type.HXblock;
import HuanXiangDIY.type.多合成A;
import HuanXiangDIY.type.状态;
import HuanXiangDIY.type.能量;
import HuanXiangDIY.事件.局内事件主类;
import HuanXiangDIY.测试的文件.测试;
import HuanXiangLIB.type.流体节点;
import HuanXiangLIB.type.物品节点;
import HuanXiangLIB.type.物流节点;
...
import static HuanXiangDIY.content.Fxsos.DFSF;
...
//    }
    public static UnlockableContent dfgd,
            sdadasdas, dvf, sandCracker, test, sdadfa, dxfgh, bridgeopacity, 哈哈哈哈哈哈哈, dtfrdgtdfgdfg, gtfdgddsfdsffgg, gtfdgdfgg, dfy, rftghf, tyfh, sdgfs, tyhj, FFFFF, ertgdfg, fsdgdfg, tasedfsyhj, tadfgsedfsyhj;
...
//       注册能力("测试1", new ForceFieldAbility(100, 1, 10000, 0)
//        );
//        注册能力("测试2", new UnitSpawnAbility(UnitTypes.dagger, 600, 0, 0)
//        );
      //  new 单位组装记录块();
        new 测试("GHN"){{
...
//        };
        ...
        sandCracker = new 多合成A("sand-cracker") {{
            size = 2;
            requirements(Category.crafting, with(Items.lead, 40, Items.copper, 60, Items.graphite, 45));
            health = 320;
            craftTime = 45f;
            itemCapacity = 20;
