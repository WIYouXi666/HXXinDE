...
public class DongTaiLiuTiXiaiHao extends Consume {
    public final Func<Building, LiquidStack[]> fluids;

    @SuppressWarnings("unchecked")
    public <T extends Building> DongTaiLiuTiXiaiHao(Func<T, LiquidStack[]> fluids) {
    ...
    private void rebuild(Building tile, Table table) {
        ...
        for (LiquidStack stack : fluids) {
            table.add(new ReqImage(new DongTaiLiuTiTuXiang(stack.liquid.uiIcon),
